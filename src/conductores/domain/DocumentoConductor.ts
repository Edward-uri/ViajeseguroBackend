...
export class DocumentoConductor {
  constructor(
...
export class DocumentoConductorBuilder {
  private _id: number | null = null;
  private _idConductor?: number;
  ...
  idConductor(v: number): this { this._idConductor = v; return this; }
  tipo(v: TipoDocumento): this { this._tipo = v; return this; }
  ...
  build(): DocumentoConductor {
    if (this._idConductor == null || !this._tipo || !this._archivoKey || !this._mimeType || this._tamanoBytes == null) {
      throw new Error('DocumentoConductor requiere idConductor, tipo, archivoKey, mimeType y tamanoBytes');
    }
    return new DocumentoConductor(
      this._id, this._idConductor, this._tipo, this._archivoKey, this._nombreOriginal,
